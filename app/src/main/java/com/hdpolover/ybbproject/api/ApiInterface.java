...
//    Call<ArrayList<WordPressPostModel>> getInfoPost();
    ...
    @GET("wp-json/wp/v2/posts?categories=10,7,6,5,9&per_page=20&_fields=id,date,link,title,excerpt,jetpack_featured_media_url")
    Call<ArrayList<WordPressPostModel>> getInfoPost();

    @GET("wp-json/wp/v2/posts?categories=1,8,4&per_page=20&_fields=id,date,link,title,excerpt,jetpack_featured_media_url")
